...
if __name__ == '__main__':
    ...
    # optimization misc
    parser.add_option('--lr',           type='float', dest='lr',            default=0.005) # 0.01
    ...
    parser.add_option('--lm_dropout',           type='float',   dest='lm_dropout',          default=0.5)
    parser.add_option('--clip',                 type='float',   dest='clip',                default=0.05)
